...
test_that("Check the intervention variable coding", {

  expect_equal(sum(subset(df, intervention == "post")$date > 20010911) == length(subset(df, intervention == "post")$date), TRUE)
