...
ggsave("/home/jae/ITS-Text-Classification/output/its_base_plot.png", width = 13)
```
...
ggsave("/home/jae/ITS-Text-Classification/output/its_adjusted_plot.png", width = 13)
...
stargazer(domestic_output, nondomestic_output, type = "text")
```
