...
write.csv(corpus_copy, here("processed_data", "corpus_copy.csv"))
```
...
keywords <- list(
    ...
    "assimilation" = c("compliance", "loyal", "fear", "assimilation", "assimilated"),
    
    "resistance" = c("legal", "civil", "constitutional", "recognize", "represent", "unite", "engage", "justice", "advocacy", "citizen"), 
    
    "surveillance" = c("fbi", "police", "surveillance", "criminal", "immigrant"),
    
    "discrimination" = c("streotype", "bias", "prejudice", "discrimination", "anti"),
    
    "terrorism" = c("terror", "terrorism", "taliban"),
    
    "foreign affairs" = c("pakistan", "middle east", "gulf", "suhatro", "indonesia", "philippine", "china", "japan", "korea")
...
vars_selected <- vars %>% select(intervention) %>%
    mutate(intervention = ifelse(intervention == 1, "Post-9/11", "Pre-9/11"))
