...
```{r}
mod1 <- conText(formula = muslim ~ intervention + group, 
          data = corpus, 
          text_var = 'clean_text', 
...
```{r}
mod2 <- conText(formula = muslim ~ intervention + group, 
          data = corpus, 
          text_var = 'clean_text', 
          pre_trained = local_glove,
          transform = TRUE, 
...
```{r}
mod3 <- conText(formula = muslim ~ intervention + group, 
          data = corpus, 
          text_var = 'clean_text', 
          pre_trained = local_glove,
          transform = TRUE, 
...
mean(mod1$normed_betas$Normed_Estimate[2]/mod1$normed_betas$Normed_Estimate[1],
mod2$normed_betas$Normed_Estimate[2]/mod2$normed_betas$Normed_Estimate[1],
mod3$normed_betas$Normed_Estimate[2]/mod3$normed_betas$Normed_Estimate[1])
