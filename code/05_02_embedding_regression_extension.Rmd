...
```
Coefficient	Normed_Estimate	Std.Error	Empirical_Pvalue
9/11 attacks	52.51782	6.066866	0.315
Arab American	29.20984	2.607220	0.285
...
ggsave(here("output", "embedreg_all.png"), height = 10)
```
...
```{r eval = FALSE}
knitr::purl(here("code", "05_02_embedding_regression_extension.Rmd"),
            here("code", "05_02_embedding_regression_extension.r"))
```