...
its_dom_plot <- visualize_placebo(df_domestic) + 
  ggtitle("Majority Interests in Domestic News") + 
  labs(tag = "A", caption = "") +
  ylim(c(0,20))
its_nondom_plot <- visualize_placebo(df_nondomestic) + 
  ggtitle("Majority Interests in International News") + 
  labs(tag = "C", 
       caption = "Source: New York Times") +
  ylim(c(0,20))

comp_its_dom_plot <- visualize_placebo(comp_df_domestic) + 
  ggtitle("Minority Interests in Doemstic News") + 
  labs(tag = "B", caption = "") +
  ylim(c(0,20))

comp_its_nondom_plot <- visualize_placebo(comp_df_nondomestic) + 
  ggtitle("Minority Interests in International News") + 
  labs(tag = "D", caption = "Source: Ethnic NewsWatch") +
  ylim(c(0,20))
